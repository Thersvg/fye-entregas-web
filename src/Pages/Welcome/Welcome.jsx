            ...
            <EntryTop>
                ...
                <ContainerContent> 
                    <SubscribeContainer>
                        ...
                        <div>
                            <Button sx={{width: '100%',color: "#fff", fontWeight: 800, borderColor: '#fff',backgroundColor: '#transparent', ":hover": {border: 'none',backgroundColor:'#fff', color: '#03bb85'}}} onClick={() => window.open('https://youtu.be/WmgZtPZJuig') } variant="outlined">ASSISTIR VIDEO</Button> 
                        </div>
